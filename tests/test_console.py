...
class TestHBNBCommand_prompting(unittest.TestCase):
    """Unittests for testing command interpreter."""
...
class TestHBNBCommand_help(unittest.TestCase):
    """Unittests for testing help messages for this command interpreter."""
