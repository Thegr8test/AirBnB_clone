...
class TestBaseModel(unittest.TestCase):
    ...
    """Test instances for the BaseModel class."""
    ...
    def test_3_instantiation(self):
        """Tests instantiation of a BaseModel called class."""
    ...
    def test_3_init_no_args(self):
        ...
        with self.assertRaises(TypeError) as e:
            BaseModel.__init__()
        msg = "__init__() missing 1 argument: 'self'"
        self.assertEqual(str(e.exception), msg)

    def test_3_init_many_args(self):
        """Tests __init__ with a number of arguments."""
        self.resetStorage()
    ...
    def test_3_attributes(self):
        """Tests attributes value for instance of a BaseModel"""
    ...
    def test_3_datetime_created(self):
        """Tests if files are current at creation."""
    ...
    def test_3_to_dict_no_args(self):
        ...
        with self.assertRaises(TypeError) as e:
            BaseModel.to_dict()
        msg = "to_dict() missing 1 required argument: 'self'"
        self.assertEqual(str(e.exception), msg)
    ...
    def test_3_to_dict_excess_args(self):
        ...
        msg = "to_dict() takes 1 argument though 2 were given"
        self.assertEqual(str(e.exception), msg)

    def test_4_instantiation(self):
        """instantiation test with **kwargs."""
    ...
    def test_4_instantiation_dict(self):
        """instantiation test with **kwargs from custom dict."""
    ...
    def test_5_save_no_args(self):
        """Tests save() without arguments."""
        self.resetStorage()
        with self.assertRaises(TypeError) as e:
            BaseModel.save()
        msg = "save() missing 1 key positional argument called: 'self'"
        self.assertEqual(str(e.exception), msg)
    ...
    def test_5_save_excess_args(self):
        ...
        msg = "save() picks 1 argument though 2 were given"
        self.assertEqual(str(e.exception), msg)
